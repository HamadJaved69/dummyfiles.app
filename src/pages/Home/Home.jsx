        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-600">
            ...
            <div>
              ...
              <p>Generate files from 10KB to 20MB to test different scenarios. Perfect for testing file size limits, upload restrictions, and storage capacity in your applications.</p>
            </div>
            <div>
